...
;       mamy nast. znaczniki :
;       1xxxxxxx  -- (0xxxxxxx = ile sektorów omin¹æ) nastêpny bajt to liczba kolejno wczytanych sektorów 
;       00000000  -- nastêpny bajt to liczba kolejno wczytanych sektorów (razem z ew. pierwszym sektorem pliku)	
;       00000001  -- nastêpne 2 bajty to numer kolejnego sektora do odczytania,
;                    nastêpny bajt to liczba kolejno wczytanych sektorów

; 4. nowa 'skompresowana' tablica indeksowa podwyzsza memlo

; 5. w wolne miejsca kitramy co siê da (np. do buforu magnetofonu)
...
SecLen = blokDanychIO1+8 ; SecLen wskazuje na komurki do wpisania d³ugoœci sektora przed przepisaniem procki na stronê $0700
CheckEOF
     INC   ToFileEndH
     BNE   NotEOF
     INC   ToFileEndH+1
...
label73
     ...
     LDA  #<[HappyUSMovedProc-offset2]     ;2601  A9 00
     STA   loader.SioJMP+1               ; po przepisaniu
     LDA  #>[HappyUSMovedProc-offset2]    ;2606  A9 0A
