...
ToFileEndL = $29
CompressedMapPos = $2A ; pozycja w skompresowanej mapie pliku
...
Sector00
     ADW MapCounter #2
ops01
     CPW MapCounter {.adr loader.SecLen}
...
AfterWormStart
	 ...
	 ; mapy sektorow pliku dla loadera
	 ; teraz trzeba dodac dlugosc skompresowanej mapy bitowej
	 ADW MEMLO CompressedMapCounter
